...
/**
 * Implement the LIST command and always return an empty directory
 */
public class EmptyList extends AbstractCommand {

    private static final Logger LOG = Logger.getLogger(EmptyList.class.getName());
    ...
    public void execute(FtpIoSession session,
        ...
        try {
            ...
            session.write(translate(session, request, context,
                    REPLY_150_FILE_STATUS_OKAY, "LIST", null));
            ...
            try {
                ...
                session.write(translate(session, request, context,
                        REPLY_425_CANT_OPEN_DATA_CONNECTION, "LIST",
                        null, virtualFtpFile));
                return;
            }
            ...
            if (!failure) {
                session.write(translate(session, request, context,
                        REPLY_226_CLOSING_DATA_CONNECTION, "LIST",
