...
public class MyStor extends AbstractCommand {
    ...
    private static final Logger LOG = Logger.getLogger(MyStor.class.getName());
    ...
    public void execute(final FtpIoSession session,
        ...
        final long transferSize = dataConnection.transferFromClient(session.getFtpletSession(), baos);
        baos.close();
